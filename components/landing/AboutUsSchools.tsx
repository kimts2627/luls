...
const School: React.FC = () => {
  return (
    <div className="w-164px flex flex-col justify-center items-center mb-40px">
      ...
      <h3 className="w-full h-48px mt-10px mb-20px flex flex-col justify-center items-center text-16px DMSans-bd">
        Club Name
        <h4 className="text-14px">205</h4>
      </h3>
      <Button
        width="164"
        height="48"
...
const AboutUsSchools: React.FC = () => {
  return (
    <section className="flex flex-col w-full">
      <h2 className="text-20px leading-28px mb-20px DMSans-bd">Participating School Lists</h2>
      ...
      <section className="mt-24px flex flex-col items-center justify-center">
        <h3 className="mb-24px text-20px">만약 리스트에 본인 학교가 없다면?</h3>
